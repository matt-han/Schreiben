...
%„SerialPortTester.exe KOMPLETT.INI /COM2“ 
...
\item
\end{itemize} 
%Programmmodus = Master / Slave / beides - Standard = Beides, d.h. Kurzschlußsteckertest
%•	/COMxy
%xy = die RS232-/V.24-Port-Nummer (der Port wird von dieser Instanz des Programms geöffnet und damit geblockt)
%•	/Batch 
%Mit Benutzereingaben, aber ohne GUI
%•	/Unattended und/oder /Silent
%ohne Benutzereingaben und/oder  ohne Ausgaben auf der Konsole
%•	/Logfile:<Name>
%•	INI-Dateiname  (ohne „/“ oder „-“)
